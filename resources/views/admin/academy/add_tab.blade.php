    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <form id="add_courses_form" name="add_courses_form" class="form d-flex flex-column flex-lg-row"
                  method="post" enctype="multipart/form-data" action="{{route('add_new_academy_tabs_save')}}">
                @csrf
                <!--begin::Main column-->
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="fv-row">
                                        ...
                                        <select class="form-select form-control form-control-solid"
                                            ...
                                            <option></option>
                                            <option value="Start Your Business" selected>Start Your Business</option>
                                            <option value="Financing & Funding">Financing & Funding</option>
                                            <option value="Legal and Taxation">Legal and Taxation</option>
                                            <option value="Registration With Chamber">Registration With Chamber</option>
                                        </select>
                                        <!--end::Input-->
                                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="add_cources_submit" class="btn btn-primary">
...
{{--    <script src="{{asset("static/js/custom/admin/course.js")}}"></script>--}}
    ...
    <script src="https://www.tinymce.com/docs/plugins/lists/"></script>
    <script src=" https://www.tinymce.com/docs/plugins/advlist/"></script>
