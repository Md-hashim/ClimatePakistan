                    ...
                    <div class="card card-flush py-4">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a class="btn btn-primary" href="{{route('add_new_academy_tabs')}}">Add New
                                </a>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped gy-7 gs-7" id="dataTable">
                            ...
                            <tr class="fw-bold fs-6 text-white border-bottom border-gray-200">
                                <th class="min-w-100px">Tab Name</th>
                            ...
                            <tr>
                                ...
                                <td class="min-w-50px text-end">
                                    ...
                                    <a href="{{route('edit_academy_tabs',['id'=>$tab->id])}}"
        ...
        function deleteNews(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.replace("/adb/academy-tabs/delete/" + id);
                }
            });
        }
    </script>
