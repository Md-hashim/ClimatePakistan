                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#add_affiliates">Add New
                            </button>
                        </div>
                    </div>
                                ...
                                <table class="table table-striped gy-7 gs-7">
                                    ...
                                    @foreach($affiliates as $affiliate)
                                        <tr>
                                            ...
                                            <td class="h-50px">
                                                <a href="{{asset("$affiliate->icon")}}" target="_blank" class="btn btn-icon btn-active-white "
                                                   data-bs-toggle="tooltip" title="Image">
                                                    <img src="{{asset("$affiliate->icon")}}" style="width: 100px;height: 100px;object-fit: contain;"/>
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="min-w-50px text-end">
                                                <!--begin::Edit-->
                                                <a href="" data-bs-toggle="modal" data-bs-target="#edit_affiliate_data"
                                                   class="btn btn-icon btn-active-light-primary w-30px h-30px"
                                                   data-affiliate-id="{{$affiliate->id}}"
                                                   data-affiliate-title="{{$affiliate->title}}"
                                                   data-affiliate-description="{{$affiliate->description}}"
                                                   data-affiliate-icon="{{$affiliate->icon}}"
                                                ...
                                                <!--end::Edit-->
                                                <!--begin::Delete-->
                                                <button id="delete_affiliate_{{$affiliate->id}}"
