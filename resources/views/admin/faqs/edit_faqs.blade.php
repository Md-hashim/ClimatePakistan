    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <form id="add_courses_form" name="add_courses_form" class="form d-flex flex-column flex-lg-row"
                  method="post" enctype="multipart/form-data" action="{{route('add_new_faqs_save')}}">
                @csrf
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid"
                                               name="question" id="question" value="{{ $faqs->question }}"
                                        />
                                        <!--end::Input-->
                                    </div>
                                </div>
                            ...
                            <div class="row mb-7 ">
                                <div class="col-lg-12 mb-3">
                                    <div class="fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea id="answer" name="answer" class="tox-target" required>{{ $faqs->answer }}</textarea>
                                        <!--end::Input-->
                                    </div>
                                </div>
                            </div>
