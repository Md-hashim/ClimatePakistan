                    ...
                    <div class="card card-flush py-4">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a class="btn btn-primary" href="{{route('add_new_faqs')}}">Add New
                                </a>
                            </div>
                        ...
                        <table class="table table-striped gy-7 gs-7" id="dataTable">
                            ...
                            <tr>
                                ...
                                <td class="min-w-50px text-end">
                                    ...
                                    <a href="{{route('edit_faqs',['id'=>$faq->id])}}"
        ...
        function deleteFAQs(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.replace("/adb/faqs/delete/" + id);
                }
            });
        }
    </script>
