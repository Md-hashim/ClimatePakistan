...
@section('title', 'Climate Solutions')
                ...
                <div class="card card-flush py-4">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <a class="btn btn-primary" href="{{route('add_new_framework')}}">Add New
                            </a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-w-50px text-end">
                                                ...
                                                <a href="{{route('edit_framework',['id'=>$framework->id])}}"
                                                ...
                                                <!--end::Edit-->
                                                <!--begin::Delete-->
{{--                                                id="delete_news_{{$tab->id}}"--}}
{{--                                                onclick="deleteNews('{{$tab->id}}')"--}}
                                                <button   id="delete_news_{{$framework->id}}"
                                                          onclick="deleteNews('{{$framework->id}}')"
        ...
        function deleteNews(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.replace("/adb/framework/delete/" + id);
                }
            });
        }
    </script>
