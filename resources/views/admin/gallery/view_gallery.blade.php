                    ...
                    <div class="card card-flush py-4">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a class="btn btn-primary" href="{{route('add_admin_gallery')}}">Add New
                                </a>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="h-50px">
                                        @if(empty($data->image))
                                            Not Available
                                        @else
                                            <a href="{{ asset($data->image) }}" target="_blank" class="btn btn-icon btn-active-white" data-bs-toggle="tooltip" title="Image">
                                                <img src="{{ asset($data->image) }}" style="width: 100%;height: 100%;object-fit: cover;"/>
                                            </a>
                                        @endif
                                    ...
                                    <td >
                                        @if(empty($data->video))
                                            Not Available
                                        @else
                                            <a href="{{ asset($data->video) }}" target="_blank" class="btn btn-icon btn-active-white" data-bs-toggle="tooltip" title="Video">
...
<path d="M21 10.7L11.1 5V19L21 13.3C22 12.7 22 11.3 21 10.7Z" fill="currentColor"/>
                                    ...
                                    <td class="min-w-50px text-end">
                                        <!--begin::Edit-->
                                        <a href="{{route('edit_admin_gallery',['id'=>$data->id])}}"
                                        ...
                                        <!--end::Edit-->
                                        <!--begin::Delete-->
                                        <button id="delete_gallery_{{$data->id}}"
