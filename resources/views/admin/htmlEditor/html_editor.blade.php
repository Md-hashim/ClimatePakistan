                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <a class="btn btn-primary" href="{{route('add_html_editor')}}">Add New
                            </a>
                        </div>
...
{{--                                                </a>--}}
                                                ...
                                                <button id="delete_data_{{$data->id}}"
                                                        onclick="deletePageBuilder('{{$data->id}}')"
        ...
        function deletePageBuilder(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.replace("/adb/html-editor-delete/" + id);
                }
            });
        }
