    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <form id="add_courses_form" name="add_courses_form" class="form d-flex flex-column flex-lg-row"
                  method="post" enctype="multipart/form-data" action="{{route('edit_news_save', ["id"=>$news->id])}}">
                @csrf
                            ...
                            <div class="row mb-7 ">
                                <div class="col-lg-12 mb-3">
                                    <div class="fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea id="content" name="content" class="tox-target" required>{{ $news->content }}</textarea>
                                        <!--end::Input-->
                                    </div>
                                </div>
                            </div>
