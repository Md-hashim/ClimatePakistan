                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a class="btn btn-primary" href="{{route('add_new_news')}}">Add New
                                </a>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped gy-7 gs-7" id="dataTable">
                            ...
                            <tr>
                                <td>{{$new->title}}</td>
                                <td  class="text-end">{{$new->status }}</td>

                                <td class="min-w-50px text-end">


                                    <a href="{{route('edit_news',['id'=>$new->id])}}"
        ...
        function deleteNews(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.replace("/adb/news/delete/" + id);
                }
            });
        }
    </script>
