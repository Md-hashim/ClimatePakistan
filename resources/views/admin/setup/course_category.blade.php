                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#add_course_category">Add New
                            </button>
                        </div>
                    </div>
                    <!--end::Card header-->
                                ...
                                <table class="table table-hover table-rounded table-striped border gy-7 gs-7">
                                    ...
                                    <tr>
                                        ...
                                        <td class="min-w-50px text-end">
                                            <!--begin::Edit-->
                                            <a
                                               onclick="editCourseCategory('{{ $category->id }}')"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button id="delete_course_category_{{$category->id}}"
                                                    onclick="deleteCourseCategory('{{$category->id}}')"
...
<path opacity="0.5" d="M9 4C9 3.44772 9.44772 3 10 3H14C14.5523 3 15 3.44772 15 4V4H9V4Z" fill="currentColor"/>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="add_category_form" name="add_category_form" method="post"
                      class="form"
                      action="{{route('add_course_category')}}" enctype="multipart/form-data">
                    @csrf
    ...
    {{--    Edit Modal--start --}}
    <div class="modal fade" tabindex="-1" id="edit_course_category">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="edit_category_form" name="edit_category_form" method="post"
                      class="form"
                      action="{{route('update_course_category')}}" enctype="multipart/form-data">
                    @csrf
...
@section('extra_scripts')
    <script src="{{asset("static/js/custom/admin/course_category.js")}}"></script>
