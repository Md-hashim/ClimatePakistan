                    ...
                    <div class="card card-flush py-4">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a class="btn btn-primary" href="{{route('add_admin_slider')}}">Add New
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped gy-7 gs-7">
                                ...
                                <tr>
                                    ...
                                    <td class="h-50px">
                                        <a href="{{asset($slider->image)}}" target="_blank" class="btn btn-icon btn-active-white"
                                           data-bs-toggle="tooltip" title="Image">
                                            <img src="{{asset("$slider->image")}}" style="width: 100%;height: 100%;object-fit: cover;"/></a></td></a></td>
                                    <td class="min-w-50px text-end">
                                        <!--begin::Edit-->
                                        <a href="{{route('edit_slider_data',['id'=>$slider->id])}}"
                                        ...
                                        <!--end::Edit-->
                                        <!--begin::Delete-->
                                        <button id="delete_slider_{{$slider->id}}"
