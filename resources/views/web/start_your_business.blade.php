...
<html lang="en">
<head>
    <title>Understanding Climate - Climate Pakistan</title>
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="page-titles whitecolor text-center padding_top padding_bottom">
                    <h2 class="font-light">
                    Understanding Climate  What Is Climate Change?
                    </h2>
                </div>
            </div>
        </div>
...
{{--                                            <img src="{{ asset("static/web/images/graph.png")}}" class="img-fluid" alt="img">--}}
...
{{--                                            <img src="{{ asset("static/web/images/stage.jpg")}}" class="img-fluid" alt="img" />--}}

{{--                                            <h3 class="font-light head-h3 darkcolor pb-4 pt-5 mt-3">--}}
{{--                                                Components of Competitor Analysis--}}

{{--                                            </h3>--}}
{{--                                            <img src="{{ asset("static/web/images/components.jpg")}}" class="img-fluid mx-auto d-block" alt="img" />--}}
...
{{--                                            </h3>--}}
{{--                                            <img src="{{ asset("static/web/images/structure.png")}}" class="img-fluid mx-auto d-block" alt="img" />--}}
...
{{--                                                    <img src="{{ asset("static/web/images/target.png")}}" class="img-fluid pt-5 xs-image-small" alt="img" />--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                                <img src="{{ asset("static/web/images/plan.png")}}" class="img-fluid pt-4" alt="img" />--}}
{{--                                            </div>--}}
...
{{--                                                <img src="{{ asset("static/web/images/plan2-mob.png")}}" class="img-fluid pt-4" alt="img" />--}}
{{--                                            </div>--}}
{{--                                            <div class="text-center d-md-none d-block">--}}
{{--                                                <img src="{{ asset("static/web/images/plan2.png")}}" class="img-fluid pt-4" alt="img" />--}}
{{--                                            </div>--}}
...
{{--                                                    <img src="{{ asset("static/web/images/fail.png")}}" class="img-fluid pt-5 xs-image-small" alt="img">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                            </p>--}}
{{--                                            <img src="{{ asset("static/web/images/product3.png")}}" class="img-fluid pt-4" alt="img" />--}}
...
{{--                                            <img src="{{ asset("static/web/images/process.png")}}" class="img-fluid pt-4 mx-auto d-block" alt="img" />--}}
...
{{--                                            </h3>--}}
{{--                                            <!--<img src="{{ asset("static/web/images/idea3.png")}}" class="img-fluid pt-4 mx-auto d-block" alt="img" />-->--}}
...
{{--                                            <img src="{{ asset("static/web/images/charts2.png")}}" class="img-fluid pt-4 mt-3 mx-auto d-block" alt="img" />--}}
...
{{--                                            </h3>--}}
{{--                                            <img src="{{ asset("static/web/images/chart3.png")}}" class="img-fluid pt-4 mx-auto d-block" alt="img" />--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                        ...
                        <aside class="sidebar whitebox mt-5 mt-md-0 ps-xl-4">
                            ...
                            <div class="widget heading_space shadow wow fadeIn" data-wow-delay="350ms">
                                ...
                                <div class="single_post d-flex mt-4">
                                    <a href="mailto:{{$settings->email_address}}" class=""><img src="{{ asset("static/web/images/email.png")}}" alt="img" width="40"></a>
                                    <div class="text">
                                        <span>Email</span>
                                        <a href="#">
