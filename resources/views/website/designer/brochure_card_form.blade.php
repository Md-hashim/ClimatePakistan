        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 pr-lg-0 whitebox">
                <div class="widget logincontainer">
                    ...
                    <form class="getin_form border-form" id="brochure_card_form" method="POST" action="{{route('submit_card_form')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group bottom35">
                                    <label for="business_name" class="d-none"></label>
                                    <input class="form-control" type="text" placeholder="Business Name:"  id="business_name" name="name">
                                    <span id="name_error" style="color:red;"></span>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group bottom35">
                                    <label for="tagline" class="d-none"></label>
                                    <input class="form-control" type="text" placeholder="Tagline:"  id="tagline" name="tagline">
...
<script>
    document.getElementById('brochure_card_form').addEventListener('submit', function(event) {
        let isValid = true;
