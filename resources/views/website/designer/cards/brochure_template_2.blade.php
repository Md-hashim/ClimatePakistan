...
<head>
    ...
    <style>
        ...
        .title {
            position: absolute;color: #fff;top: 18%; left: 1.5%;font-size: 30px;font-weight: bold
        }
        .name {
            position: absolute;color: #fff;top: 22%; left: 1.5%;font-size: 30px;font-weight: bold
        }
        .tagline{position: absolute;color: #fff;top:65%; left: 1.5%;font-size: 28px;width: 10%;height: auto;font-weight: bolder}
        .about{position: absolute;color: #000;top: 64%; left: 35.5%;font-size: 18px;width: 30%;height: auto}
        .address{position: absolute;color: #000;top:77%; left: 77.5%;font-size: 14px;}
        .email{position: absolute;color: #000;top:79%; left: 77.5%;font-size: 14px;}
        .website{position: absolute;color: #000;top:81%; left: 77.5%;font-size: 14px;}
        .contact_number{position: absolute;color: #000;top:83%; left: 77.5%;font-size: 14px;}
...
<div id="image">
    ...
    <div class="brochure">
        <img src="{{ 'media/cardDesigns/brochure_3.png' }}" alt="Brochure Image">
