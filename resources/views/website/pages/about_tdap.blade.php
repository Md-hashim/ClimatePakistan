...
@section('main_content')
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1 col-md-5 col-sm-5 wow fadeInRight" data-wow-delay="300ms">
                    <div class="image"><img alt="SEO" src="{{asset('static/media/website-images/ev4.png')}}"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Counters ends-->
    <!-- Our Team-->
    <section class=" parallax n-banner-cs n-banner-cs2" style="background:url('{{asset('static/media/website-images/WhatsApp-Image-2022-08-27-at-8.08.06-PM-1-1.jpeg')}}')">
                ...
                <div class="col-lg-6 col-md-7 offset-lg-1 col-sm-7 pt-md-0 pt-5 wow fadeInRight" data-wow-delay="300ms">
                    <div class="heading-title mb-4">
                        <h2 class="darkcolor font-normal bottom30 head-h2">
                            TDAP's <span class="defaultcolor"> Mission </span>
                        </h2>
                    </div>
                    <p class="bottom35">
    ...
    <section class="single-feature padding">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 col-md-7 col-sm-7  wow fadeInLeft" data-wow-delay="300ms">
                    <div class="heading-title mb-4">
                        <h2 class="darkcolor font-normal bottom30 head-h2">TDAP's  <span class="defaultcolor">Vision</span></h2>
                    </div>
                    <p class="bottom35">
